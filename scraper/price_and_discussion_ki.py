#run this file to combine price and discussion info of one day into a json 
...
def combine_price_discussion(prefix):
    '''
...
rv = combine_price_discussion(PREFIX)
filename = "2018-03-06_price_and_discussion.json"
